package gg.cncmc.battlehelper.utility;
...
public class teamStorage {
    ...
    private static final String FILE_NAME = "battlehelper_teams.json";
    ...
    private void save() {
        try (Writer writer = new FileWriter(filePath)) {
            ...
            LOGGER.error("[BattleHelper] Failed to save teams: " + e.getMessage());
        }
    }
    ...
    private void load() {
        ...
        try (Reader reader = new FileReader(filePath)) {
            ...
            LOGGER.error("[BattleHelper] Failed to load teams: " + e.getMessage());
        }
    }
